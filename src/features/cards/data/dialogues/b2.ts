...
export const B2_DIALOGUES: Dialogue[] = [
  {
    ...
    blanks: [
      [
        { en: "feasible", ko: "실현 가능한" },
        { en: "doable", ko: "할 수 있는" },
        { en: "realistic", ko: "현실적인" },
      ],
      [
        { en: "adjust", ko: "조정하다" },
        { en: "revisit", ko: "재검토하다" },
        { en: "reprioritise", ko: "우선순위를 다시 정하다" },
      ],
      [
        { en: "scope", ko: "범위" },
        { en: "timeline", ko: "일정" },
        { en: "deliverables", ko: "산출물" },
      ],
    ],
    example: {
  ...
  },
  {
    ...
    blanks: [
      [
        { en: "concerned", ko: "우려하는" },
        { en: "worried", ko: "걱정하는" },
        { en: "hesitant", ko: "망설여지는" },
      ],
      [
        { en: "compromise", ko: "훼손하다" },
  ...
  },
  {
    ...
    blanks: [
      ...
      [
        { en: "thrive", ko: "잘 해낸다" },
        { en: "focus better", ko: "더 잘 집중한다" },
        { en: "stay motivated", ko: "동기를 유지한다" },
      ],
      [
        { en: "feel isolated", ko: "고립감을 느낀다" },
        { en: "struggle to switch off", ko: "일을 끄기 어려워한다" },
        { en: "miss the structure", ko: "체계를 그리워한다" },
      ],
    ],
    example: {
  ...
  },
  {
    ...
    blanks: [
      [
        { en: "frustrating", ko: "답답한" },
        { en: "troubling", ko: "걱정스러운" },
        { en: "telling", ko: "시사하는 바가 큰" },
      ],
      [
        { en: "keeping up at", ko: "따라가지 못하는" },
        { en: "rising at", ko: "오르지 않는" },
        { en: "matching", ko: "맞추지 못하는" },
      ],
      [
        { en: "pace", ko: "속도" },
        { en: "rate", ko: "비율" },
  ...
  },
  {
    ...
    blanks: [
      [
        { en: "love", ko: "정말 가고 싶다" },
        { en: "have loved", ko: "정말 가고 싶었다" },
        { en: "really like", ko: "꽤 가고 싶다" },
      ],
      [
        { en: "committed to", ko: "약속한" },
        { en: "got tied up with", ko: "묶여 있는" },
        { en: "made plans for", ko: "계획을 잡은" },
      ],
      [
        { en: "evening", ko: "저녁" },
        { en: "weekend", ko: "주말" },
  ...
  },
  {
    ...
    blanks: [
      ...
      [
        { en: "by end of day", ko: "오늘 안으로" },
        { en: "first thing tomorrow", ko: "내일 아침 제일 먼저" },
        { en: "shortly", ko: "곧" },
      ],
    ],
    example: {
  ...
  },
  {
    ...
    blanks: [
      [
        { en: "flexible", ko: "유연한" },
        { en: "open", ko: "열린" },
        { en: "willing to move", ko: "조정할 의향이 있는" },
      ],
      [
        { en: "commit to", ko: "약속하다" },
        { en: "sign up for", ko: "계약하다" },
        { en: "consider", ko: "고려하다" },
      ],
      [
        { en: "contract", ko: "계약" },
  ...
  },
  {
    ...
    blanks: [
      [
        { en: "stay calm", ko: "침착함을 유지하다" },
        { en: "keep focused", ko: "집중을 유지하다" },
        { en: "adapt quickly", ko: "빠르게 적응하다" },
      ],
      [
        { en: "invaluable", ko: "매우 귀중한" },
        { en: "a real asset", ko: "진정한 강점인" },
        { en: "essential", ko: "필수적인" },
      ],
      [
        { en: "meeting", ko: "맞출 때" },
        { en: "handling", ko: "감당할 때" },
        { en: "facing", ko: "직면할 때" },
      ],
    ],
    example: {
  ...
  },
  {
    ...
    blanks: [
      [
        { en: "long-standing", ko: "오래된" },
        { en: "deeply rooted", ko: "깊이 뿌리내린" },
        { en: "widespread", ko: "널리 퍼진" },
      ],
      [
        { en: "keep", ko: "유지하다" },
        { en: "leave", ko: "유지해 두다" },
