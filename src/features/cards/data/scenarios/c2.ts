    ...
    turns: [
      {
        ...
        blanks: [
          ...
          [
            { en: "compelling", ko: "설득력 있습니다" },
            { en: "all but unanswerable", ko: "거의 반박 불가입니다" },
            { en: "deceptively simple", ko: "겉보기보다 단순합니다" },
          ],
          [
            { en: "dismantles", ko: "허물고" },
            { en: "does away with", ko: "없애 버리고" },
            { en: "sidesteps", ko: "피해 가고" },
          ],
          [
            { en: "in doing so", ko: "그렇게 함으로써" },
            { en: "above all", ko: "무엇보다" },
            { en: "crucially", ko: "결정적으로" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "With respect,", ko: "외람되지만," },
            { en: "If I may,", ko: "한 말씀 드리면," },
            { en: "Let me be candid:", ko: "솔직히 말씀드리면:" },
          ],
          [
            { en: "ruinous", ko: "파멸적으로" },
            { en: "prohibitive", ko: "감당 불가로" },
            { en: "alarming", ko: "우려스럽게" },
          ],
          [
            { en: "conveniently ignore", ko: "편의적으로 무시할" },
            { en: "leave out of the ledger", ko: "장부에서 빼놓을" },
            { en: "fail to net off", ko: "상계하지 않을" },
          ],
          [
            { en: "stand to eliminate", ko: "없앨 수 있는" },
            { en: "would no longer carry", ko: "더는 짊어지지 않을" },
            { en: "currently bankroll", ko: "지금 떠받치고 있는" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "runs ahead of", ko: "앞서갑니다" },
            { en: "outpaces", ko: "넘어섭니다" },
            { en: "simply isn't borne out by", ko: "결코 뒷받침되지 않습니다" },
          ],
          [
            { en: "barely moving", ko: "거의 변하지 않고" },
            { en: "holding steady", ko: "그대로 유지되며" },
            { en: "dipping only marginally", ko: "미미하게만 줄며" },
          ],
          [
            { en: "all but vanishes", ko: "거의 사라집니다" },
            { en: "evaporates", ko: "증발해 버립니다" },
            { en: "fails to materialize", ko: "현실화되지 않습니다" },
          ],
          [
            { en: "control", ko: "통제하면" },
            { en: "account", ko: "고려하면" },
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "In the final analysis", ko: "결국" },
            { en: "When all is said and done", ko: "모든 걸 따져 보면" },
            { en: "Let me leave you with this", ko: "이 한마디로 끝맺겠습니다" },
          ],
          [
            { en: "any longer", ko: "더 이상" },
            { en: "in good conscience", ko: "양심상" },
            { en: "morally", ko: "도덕적으로" },
          ],
          [
            { en: "indignities", ko: "굴욕들을" },
            { en: "means-tested cruelty", ko: "자산 심사라는 잔인함을" },
            { en: "patchwork of stigma", ko: "낙인의 누더기를" },
          ],
          [
            { en: "tolerate", ko: "용인하도록" },
            { en: "treat as normal", ko: "당연시하도록" },
            { en: "look past", ko: "외면하도록" },
          ],
        ],
        example: {
    ...
    turns: [
      {
        ...
        blanks: [
          [
            { en: "I appreciate", ko: "충분히 이해합니다" },
            { en: "I don't underestimate", ko: "과소평가하지 않습니다" },
            { en: "Let me acknowledge", ko: "인정하겠습니다" },
          ],
          [
            { en: "paper over", ko: "덮으려" },
            { en: "make light of", ko: "가볍게 여기려" },
            { en: "talk past", ko: "외면하려" },
          ],
          [
            { en: "a failure of sequencing", ko: "순서의 어긋남에" },
            { en: "crossed wires", ko: "오해와 엇갈림에" },
            { en: "timing and optics", ko: "시점과 모양새에" },
          ],
          [
            { en: "irreconcilable", ko: "화해 불가한" },
            { en: "fundamental", ko: "근본적인" },
            { en: "substantive", ko: "실질적인" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "press", ko: "압박하지" },
            { en: "ask", ko: "요청하지" },
            { en: "back you into", ko: "몰아붙여" },
          ],
          [
            { en: "That said", ko: "그렇지만" },
            { en: "If I read you correctly", ko: "제가 제대로 이해했다면" },
            { en: "Setting the headline aside", ko: "표면적 수치는 차치하고" },
          ],
          [
            { en: "room to maneuver", ko: "운신의 여지가" },
            { en: "latitude", ko: "재량이" },
            { en: "give", ko: "여지가" },
          ],
          [
            { en: "headline figure", ko: "표면 수치는" },
            { en: "topline", ko: "최상단 수치는" },
            { en: "ceiling", ko: "상한은" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          ...
          [
            { en: "take to the podium", ko: "연단에서 내세울" },
            { en: "sell at home", ko: "본국에서 내세울" },
            { en: "claim credit for", ko: "공으로 내세울" },
          ],
          [
            { en: "his initiative", ko: "그의 주도로" },
            { en: "a concession he secured", ko: "그가 얻어 낸 양보로" },
            { en: "a breakthrough", ko: "돌파구로" },
          ],
          [
            { en: "cede", ko: "양보하겠습니다" },
            { en: "concede", ko: "내어드리겠습니다" },
            { en: "hand over", ko: "넘겨드리겠습니다" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "capture", ko: "담아 두고" },
            { en: "set down", ko: "적어 두고" },
            { en: "lock in", ko: "확정해 두고" },
          ],
          [
            { en: "hand off", ko: "넘기고" },
            { en: "delegate", ko: "위임하고" },
          ...
          [
            { en: "have", ko: "하도록 하시죠" },
            { en: "let", ko: "하게 하시죠" },
            { en: "arrange for", ko: "주선하시죠" },
          ],
          [
            { en: "in lockstep", ko: "보조를 맞춰" },
            { en: "from the same script", ko: "같은 원고로" },
            { en: "in parallel", ko: "동시에" },
          ],
        ],
        example: {
    ...
    turns: [
      {
        ...
        blanks: [
          [
            { en: "blunt", ko: "단도직입적으로 말하죠" },
            { en: "direct", ko: "직설적으로 말하죠" },
            { en: "unsparing", ko: "에누리 없이 말하죠" },
          ],
          [
            { en: "flatter", ko: "돋보이게 하지만" },
            { en: "prop up", ko: "떠받치지만" },
            { en: "juice", ko: "끌어올리지만" },
          ],
          [
          ...
          [
            { en: "running on fumes", ko: "거의 바닥난 상태입니다" },
            { en: "living off the past", ko: "과거의 유산으로 버티고 있습니다" },
            { en: "coasting", ko: "관성으로 버티고 있습니다" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "I won't sugarcoat", ko: "포장하지 않겠습니다" },
            { en: "I take", ko: "받아들입니다" },
            { en: "Let's not minimize", ko: "축소하지 맙시다" },
          ],
          [
            { en: "ring-fencing", ko: "따로 떼어 둔" },
            { en: "committing", ko: "투입하는" },
            { en: "staking", ko: "거는" },
          ],
          [
            { en: "spread", ko: "분산해" },
            { en: "diversified", ko: "다각화해" },
            { en: "hedged", ko: "헤지해" },
          ],
          [
            { en: "kill switches", ko: "중단 기준을" },
            { en: "off-ramps", ko: "철수 지점을" },
            { en: "stage gates", ko: "단계별 관문을" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "out ahead", ko: "선수를 쳐서" },
            { en: "in front", ko: "먼저 만나서" },
            { en: "ahead", ko: "앞서서" },
          ],
          [
            { en: "frame", ko: "규정하고" },
            { en: "cast", ko: "내세우고" },
            { en: "position", ko: "자리매김하고" },
          ],
          [
            { en: "dangle", ko: "내걸어" },
            { en: "commit to", ko: "약속해" },
          ...
          [
            { en: "reassures", ko: "안심시키도록" },
            { en: "signals to", ko: "신호를 주도록" },
            { en: "reminds", ko: "상기시키도록" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "Three things", ko: "세 가지입니다" },
            { en: "In plain terms", ko: "분명히 말씀드리면" },
            { en: "Concretely", ko: "구체적으로는" },
          ],
          [
            { en: "quarterly", ko: "분기별" },
            { en: "milestone-gated", ko: "성과 관문별" },
            { en: "no-surprises", ko: "돌발 없는" },
          ],
          [
            { en: "mandate", ko: "권한을" },
            { en: "discretion", ko: "재량을" },
            { en: "latitude", ko: "여지를" },
          ],
          [
            { en: "sees", ko: "보도록" },
            { en: "reads", ko: "읽도록" },
            { en: "is met with", ko: "마주하도록" },
          ],
        ],
        example: {
    ...
    turns: [
      {
        ...
        blanks: [
          [
            { en: "I take", ko: "받아들입니다" },
            { en: "You're right to flag", ko: "지적은 정당합니다" },
            { en: "I grant", ko: "인정합니다" },
          ],
          [
            { en: "foreground", ko: "전면에 내세웁니다" },
            { en: "address head-on", ko: "정면으로 다룹니다" },
            { en: "don't shy away from", ko: "회피하지 않습니다" },
          ],
          [
            { en: "deliberately chosen", ko: "의도적으로 택했습니다" },
            { en: "purpose-built", ko: "목적에 맞춰 설계했습니다" },
            { en: "optimized", ko: "최적화했습니다" },
          ],
          [
            { en: "hedged", ko: "신중히 한정했습니다" },
            { en: "scoped", ko: "범위를 좁혔습니다" },
            { en: "qualified", ko: "단서를 달았습니다" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "mapped", ko: "윤곽을 그렸고" },
            { en: "charted", ko: "지도를 그렸고" },
            { en: "broke ground on", ko: "초석을 놓았고" },
          ],
          [
            { en: "indebted", ko: "빚지고 있습니다" },
            { en: "happy to give credit", ko: "기꺼이 공을 돌립니다" },
            { en: "explicit in my debt", ko: "그 빚을 분명히 밝힙니다" },
          ],
          [
            { en: "departure", ko: "차별점은" },
            { en: "contribution", ko: "기여는" },
            { en: "novelty", ko: "독창성은" },
          ],
          [
            { en: "breaks down", ko: "무너진다는" },
            { en: "fails to hold", ko: "성립하지 않는다는" },
            { en: "comes apart", ko: "허물어진다는" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "Fair challenge", ko: "타당한 지적입니다" },
            { en: "Point taken", ko: "지적 받아들입니다" },
            { en: "That's a fair pushback", ko: "정당한 반론입니다" },
          ],
          [
            { en: "narrow", ko: "좁히는" },
            { en: "temper", ko: "누그러뜨리는" },
            { en: "rein in", ko: "고삐를 죄는" },
          ],
          [
            { en: "overstate", ko: "부풀리는" },
            { en: "oversell", ko: "과대 포장하는" },
            { en: "stretch", ko: "늘려 잡는" },
          ],
          [
            { en: "hypothesis to test", ko: "검증할 가설로" },
            { en: "provocation", ko: "문제 제기로" },
            { en: "transferable lens", ko: "이전 가능한 렌즈로" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "Honestly", ko: "솔직히" },
            { en: "Without hesitation", ko: "주저 없이" },
            { en: "First and foremost", ko: "무엇보다 먼저" },
          ],
          [
            { en: "broaden", ko: "넓히고" },
            { en: "extend", ko: "확장하고" },
            { en: "replicate", ko: "재현하고" },
          ],
          [
            { en: "shore up", ko: "보강하고" },
            { en: "stress-test", ko: "엄격히 검증하고" },
            { en: "firm up", ko: "다지고" },
          ],
          [
            { en: "blind", ko: "블라인드로 맡기겠습니다" },
            { en: "hand off", ko: "넘기겠습니다" },
            { en: "open up", ko: "개방하겠습니다" },
          ],
        ],
        example: {
    ...
    turns: [
      {
        ...
        blanks: [
          [
            { en: "I don't doubt", ko: "의심하지 않습니다" },
            { en: "I respect", ko: "존중합니다" },
            { en: "I'll take you at your word on", ko: "그 말씀 그대로 믿겠습니다" },
          ],
          [
            { en: "implies", ko: "전제로 합니다" },
            { en: "bakes in", ko: "내포합니다" },
            { en: "assumes", ko: "가정합니다" },
          ],
          [
            { en: "interrogate", ko: "따져 보는 게" },
            { en: "stress-test", ko: "엄밀히 검증하는 게" },
            { en: "build up", ko: "쌓아 올리는 게" },
          ],
          [
            { en: "dance", ko: "빙빙 도는 것보다" },
            { en: "posture", ko: "허세를 부리는 것보다" },
            { en: "tiptoe", ko: "조심스레 도는 것보다" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "real", ko: "실재합니다" },
            { en: "undeniable", ko: "부정할 수 없습니다" },
            { en: "genuine", ko: "진짜입니다" },
          ],
          [
            { en: "riding", ko: "기대고 있습니다" },
            { en: "leaning hard", ko: "크게 의존하고 있습니다" },
            { en: "perched", ko: "위태롭게 얹혀 있습니다" },
          ],
          [
            { en: "Price in", ko: "반영하면" },
            { en: "Factor in", ko: "감안하면" },
            { en: "Discount for", ko: "할인하면" },
          ],
          [
            { en: "tells a different story", ko: "다른 이야기를 합니다" },
            { en: "lands well south of yours", ko: "귀측보다 한참 아래입니다" },
            { en: "narrows fast", ko: "빠르게 좁혀집니다" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "Let's bridge", ko: "메워 봅시다" },
            { en: "I can close", ko: "좁힐 수 있습니다" },
            { en: "We split", ko: "나눕시다" },
          ],
          [
            { en: "keep", ko: "가져가고" },
          ...
          [
            { en: "Where's the objection", ko: "어디가 걸리십니까" },
            { en: "Can you live with that", ko: "그 정도면 받아들이실 수 있습니까" },
            { en: "Is that workable", ko: "그게 실현 가능합니까" },
          ],
        ],
        example: {
      ...
      },
      {
        ...
        blanks: [
          [
            { en: "Keep it clean", ko: "단순하게 가죠" },
            { en: "Here's the shape", ko: "구조는 이렇습니다" },
            { en: "Simple as this", ko: "이만큼 단순합니다" },
          ],
          [
            { en: "earned out", ko: "성과로 지급되며" },
            { en: "released", ko: "풀리며" },
            { en: "vesting", ko: "확정되며" },
          ],
          [
            { en: "audited milestones", ko: "감사받는 기준을 두어" },
            { en: "an agreed formula", ko: "합의된 산식을 두어" },
            { en: "clear triggers", ko: "명확한 발동 조건을 두어" },
          ],
          [
            { en: "lock in", ko: "확정하겠습니다" },
            { en: "sign", ko: "체결하겠습니다" },
            { en: "shake on", ko: "악수로 매듭짓겠습니다" },
          ],
        ],
        example: {
