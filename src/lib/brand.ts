...
export const BRAND = {
  ...
  meta: {
    title: {
      ...
      zh: "Loopla — 用SRS学韩语",
      vi: "Loopla — Học tiếng Hàn với SRS",
    },
    description: {
      ...
      vi: "Học tiếng Hàn từ ngôn ngữ bạn đã biết — thẻ ghi nhớ lặp lại ngắt quãng FSRS, từ A1 đến C2, chạy hoàn toàn cục bộ trong trình duyệt. Không cần đăng ký.",
    },
  },
} as const;
